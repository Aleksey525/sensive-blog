...
def index(request):
    most_popular_posts = Post.objects.popular()\
        .prefetch_tags_author()[:5].fetch_with_comments_count()

    fresh_posts = Post.objects.fresh()\
        .prefetch_tags_author().fetch_with_comments_count()
...
def tag_filter(request, tag_title):
    ...
    related_posts = tag.posts.all().prefetch_tags_author()[:20].fetch_with_comments_count()
